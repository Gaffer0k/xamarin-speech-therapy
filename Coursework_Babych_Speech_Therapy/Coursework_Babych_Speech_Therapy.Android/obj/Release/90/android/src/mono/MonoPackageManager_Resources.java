...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Coursework_Babych_Speech_Therapy.Android.dll" comes first in this list. */
		"Coursework_Babych_Speech_Therapy.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"Coursework_Babych_Speech_Therapy.dll",
		"FormsViewGroup.dll",
